...
====================================
1. Open the Unity scene "AudioInput" in the Unity Editor and start the scene. 
...
At the very top, you'll see a "play audio" button. This button can play back an mp3 file for testing.
...
6. After connecting, press the "play audio" button at the top to start playback. Audio should begin playing.
Note: Panning does not yet work on all devices as they might default to mono play back.
Alternative tests:
...
Pitfalls:
====================================
If you want to use this example alongside others (like VideoInput), set the USE_UNIQUE_FACTORY flag to true
in AudioInputExample.cs. This disables hardware microphone access globally in favor of AudioInput.
AudioInput is still in development, and the API may change without warning.